...
Attribution-NonCommercial-ShareAlike 3.0 United States (cc) 2008-2010 <http://creativecommons.org/licenses/by-nc-sa/3.0/>
 --><!-- 
 modification:
 changed rdf:about="#{@refid}" to rdf:about="#{@id}" 2015-12-07ma
 -->
        ...
        <xsl:if test="@type = 'area'">
            <vra:area>
                <rdf:Description>
                    ...
                    <xsl:if test="@unit = 'inÃÂ²'">
                        <vra:unitCode>
                            <xsl:text>INK</xsl:text>
                        </vra:unitCode>
                    </xsl:if>
                    <xsl:if test="@unit = 'cmÃÂ²'">
                        <vra:unitCode>
                            <xsl:text>CMK</xsl:text>
                        </vra:unitCode>
                    </xsl:if>
                    <xsl:if test="@unit = 'ftÃÂ²'">
                        <vra:unitCode>
                            <xsl:text>FTK</xsl:text>
                        </vra:unitCode>
                    </xsl:if>
                    <xsl:if test="@unit = 'mÃÂ²'">
                        <vra:unitCode>
                            <xsl:text>MTK</xsl:text>
                        </vra:unitCode>
                    </xsl:if>
                    <xsl:if test="@unit = 'ydÃÂ²'">
                        <vra:unitCode>
